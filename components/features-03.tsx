...
import Bureau1 from '@/public/images/tangram/bureau1-2.jpg'
import Bureau2 from '@/public/images/tangram/bureau2-2.jpg'
import Bureau5 from '@/public/images/tangram/bureau5-2.jpg'
          ...
          <div className="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              <div className="mb-8">
                ...
                <p className="text-lg text-zinc-500">
                  A Tangram, votre bureau, c'est <strong>VOTRE</strong> bureau.
              ...
              <div className="mb-8 md:mb-0 space-y-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-zinc-500">
                      Lumineux et sur cour également, ce bureau est entièrement disponible.
                      Il est possible de l'étendre à 3 personnes pour de petites entreprises et associations si besoin.
                    </div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">
                      Bureau 3 places plein ouest (21m²)
                    </div>
                    <div className="text-zinc-500">
            ...
            <div className="relative lg:max-w-none">
              <div className="relative flex flex-col" ref={tabs}>
                ...
                >
                  <div>
                    <Image className="lg:max-w-none mx-auto rounded-lg shadow-2xl" src={Bureau1} width={800} height={620} alt="Bureau 1" />
                  </div>
                </Transition>
                {/* Item 2 */}
                <Transition
                ...
                >
                  <div>
                    <Image className="lg:max-w-none mx-auto rounded-lg shadow-2xl" src={Bureau2} width={800} height={620} alt="Bureau 2" />
                  </div>
                </Transition>
                {/* Item 3 */}
                <Transition
                ...
                >
                  <div>
                    <Image className="lg:max-w-none mx-auto rounded-lg shadow-2xl" src={Bureau5} width={800} height={620} alt="Bureau 5" />
                  </div>
                </Transition>
              </div>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16">
            ...
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Administratif</h3>
              </div>
              <p className="text-sm text-zinc-500">
                Domiciliation, Internet Fibre, Imprimante, assurance tout ça...
              </p>
            </div>
            {/* Block #2 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Échanges</h3>
              </div>
              <p className="text-sm text-zinc-500">
                Des coworkers sympa avec des métiers variés qui aime bien rigoler.
              </p>
            </div>
            {/* Block #3 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Pratique</h3>
              </div>
              <p className="text-sm text-zinc-500">
                Accès 24/7, vous avez les clefs, 150m² de bureaux au total.
              </p>
            </div>
            {/* Block #4 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Fonctionnement</h3>
              </div>
              <p className="text-sm text-zinc-500">
                On tourne en association avec une AG une fois par an, l'occasion d'un resto de plus entre nous.
              </p>
            </div>
            {/* Block #5 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Réceptif</h3>
              </div>
              <p className="text-sm text-zinc-500">
                Salle de réunion 10 places. On va pas se mentir, on s'en sert plus souvent pour l'apéro.
              </p>
            </div>
            {/* Block #6 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Parties communes</h3>
              </div>
              <p className="text-sm text-zinc-500">
                Salle "cuisine" 2 micro-ondes 1 frigo, machine à café, évier, couverts et assiettes
              </p>
            </div>
          </div>
        </div>
